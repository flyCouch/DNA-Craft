# ==============================================================================
# PROJECT:   DNA_MARK_I_V52_SEQUENTIAL_POLAR
# THEME:     Clinical Blue / Medical White
# FOCUS:     Anti-Whip Logic (R then X) / Rapid Rotation / Single Decimal DRO
...
class DNAMarkI(ctk.CTk):
    def __init__(self):
        ...
        print(f"Project: DNA_MARK_I_V52 | Date: {datetime.now().strftime('%Y-%m-%d')} | Time: {datetime.now().strftime('%H:%M:%S')}")
        ...
        # Speed Sliders
        self.speed_r = ctk.IntVar(value=3000) # Increased default for rapid rotation
    ...
    def setup_ui(self):
        ...
        # DRO Readout (Optimized for R-X Logic)
